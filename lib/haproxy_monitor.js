...
// METRICS IDS
var metrics = [];
metrics["qcur"] =  {id:"1801:Current Queued Requests:4",index:2,ratio:false};
metrics["scur"] =  {id:"1802:Current Sessions:4",index:4,ratio:false};
metrics["stot"] =  {id:"1803:Total Sessions/Sec:4",index:7,ratio:true};
metrics["bin"] =  {id:"1804:Bytes in/Sec:4",index:8,ratio:true};
metrics["bout"] =  {id:"1805:Bytes out/Sec:4",index:9,ratio:true};
metrics["ereq"] =  {id:"1806:Request Errors/Sec:4",index:12,ratio:true};
metrics["econ"] =  {id:"1807:Connection Errors/Sec:4",index:13,ratio:true};
metrics["eresp"] =  {id:"1808:Repsonse Errors/Sec:4",index:14,ratio:true};
metrics["act"] =  {id:"1809:Server is Active:9",index:19,ratio:false};
metrics["bck"] =  {id:"1810:Server is Backup:9",index:20,ratio:false};
metrics["backend_act"] =  {id:"1811:Number of Active Servers:4",index:19,ratio:false};
metrics["backend_bck"] =  {id:"1812:Number of Backup Servers:4",index:20,ratio:false};
